...
public class OrderCreator {
    public static OrderEntity CreateOrder(UserService userService, AddressService addressService, OrderService orderService, CartProductService cartProductService, List<Object> req,String status) throws ParseException {
        // get request data
